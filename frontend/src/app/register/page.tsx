		...
		<div className="flex min-h-screen items-center justify-center px-4 py-12">
			<div className="w-full max-w-[340px] space-y-4">
				<div className="text-center">
					...
					<p className="text-sm text-zinc-500 dark:text-zinc-400 mb-8">Join ProjectManager to get started</p>
				</div>
				...
				<div className="text-sm text-center space-x-1">
					...
					<Link href="/login" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 hover:underline">
						Sign in
					</Link>
				</div>
			</div>
